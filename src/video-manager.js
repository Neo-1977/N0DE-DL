...
let mp4decrypt = '/home/sling/binaries/linux/mp4decrypt'
let decrypter = './home/sling/binaries/linux/foobar'
if (opsys === 'darwin') {
  decrypter = 'binaries/mac/foobar'
} else if (opsys === 'win32' || opsys === 'win64') {
  console.error('FUCK NOT SUPPORTED YET')
} else if (opsys === 'linux') {
  decrypter = '/home/sling/binaries/linux/foobar'
  mp4decrypt = '/home/sling/binaries/linux/mp4decrypt'
}
